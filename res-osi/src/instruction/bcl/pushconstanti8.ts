...
/**
 * InstructionBCLPushConstanti8 constructor.
 */
@typed.decorate('InstructionBCLPushConstanti8')
export class InstructionBCLPushConstanti8 extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'PushConstanti8';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x43);
