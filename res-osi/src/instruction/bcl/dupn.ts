...
/**
 * InstructionBCLDupN constructor.
 */
@typed.decorate('InstructionBCLDupN')
export class InstructionBCLDupN extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'DupN';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x34);
