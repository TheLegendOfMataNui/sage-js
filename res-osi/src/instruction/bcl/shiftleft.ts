...
/**
 * InstructionBCLShiftLeft constructor.
 */
@typed.decorate('InstructionBCLShiftLeft')
export class InstructionBCLShiftLeft extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'ShiftLeft';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x77);
