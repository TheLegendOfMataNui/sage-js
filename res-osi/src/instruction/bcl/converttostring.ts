...
/**
 * InstructionBCLConvertToString constructor.
 */
@typed.decorate('InstructionBCLConvertToString')
export class InstructionBCLConvertToString extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'ConvertToString';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xB0);
