...
/**
 * InstructionBCLPushConstantString constructor.
 */
@typed.decorate('InstructionBCLPushConstantString')
export class InstructionBCLPushConstantString extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'PushConstantString';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x46);
