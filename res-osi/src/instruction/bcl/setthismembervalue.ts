...
/**
 * InstructionBCLSetThisMemberValue constructor.
 */
@typed.decorate('InstructionBCLSetThisMemberValue')
export class InstructionBCLSetThisMemberValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'SetThisMemberValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x15);
