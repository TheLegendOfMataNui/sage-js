...
/**
 * InstructionBCLInsertIntoArray constructor.
 */
@typed.decorate('InstructionBCLInsertIntoArray')
export class InstructionBCLInsertIntoArray extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'InsertIntoArray';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x96);
