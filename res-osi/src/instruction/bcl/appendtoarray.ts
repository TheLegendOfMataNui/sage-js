...
/**
 * InstructionBCLAppendToArray constructor.
 */
@typed.decorate('InstructionBCLAppendToArray')
export class InstructionBCLAppendToArray extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'AppendToArray';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x94);
