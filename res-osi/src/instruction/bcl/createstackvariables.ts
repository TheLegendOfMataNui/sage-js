...
/**
 * InstructionBCLCreateStackVariables constructor.
 */
@typed.decorate('InstructionBCLCreateStackVariables')
export class InstructionBCLCreateStackVariables extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'CreateStackVariables';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x23);
