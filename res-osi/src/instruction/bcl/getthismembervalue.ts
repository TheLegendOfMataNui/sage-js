...
/**
 * InstructionBCLGetThisMemberValue constructor.
 */
@typed.decorate('InstructionBCLGetThisMemberValue')
export class InstructionBCLGetThisMemberValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetThisMemberValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x16);
