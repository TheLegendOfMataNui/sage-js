...
/**
 * InstructionBCLSetMemberValue constructor.
 */
@typed.decorate('InstructionBCLSetMemberValue')
export class InstructionBCLSetMemberValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'SetMemberValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x10);
