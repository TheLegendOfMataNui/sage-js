...
/**
 * InstructionBCLGetMemberFunction constructor.
 */
@typed.decorate('InstructionBCLGetMemberFunction')
export class InstructionBCLGetMemberFunction extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetMemberFunction';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x12);
