...
/**
 * InstructionBCLGetMemberValue constructor.
 */
@typed.decorate('InstructionBCLGetMemberValue')
export class InstructionBCLGetMemberValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetMemberValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x11);
