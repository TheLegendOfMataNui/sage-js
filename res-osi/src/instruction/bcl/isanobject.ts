...
/**
 * InstructionBCLIsAnObject constructor.
 */
@typed.decorate('InstructionBCLIsAnObject')
export class InstructionBCLIsAnObject extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'IsAnObject';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xBB);
