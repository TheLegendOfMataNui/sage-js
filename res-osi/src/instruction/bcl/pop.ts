...
/**
 * InstructionBCLPop constructor.
 */
@typed.decorate('InstructionBCLPop')
export class InstructionBCLPop extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Pop';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x30);
