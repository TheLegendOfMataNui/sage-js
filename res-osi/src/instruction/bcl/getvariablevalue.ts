...
/**
 * InstructionBCLGetVariableValue constructor.
 */
@typed.decorate('InstructionBCLGetVariableValue')
export class InstructionBCLGetVariableValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetVariableValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x21);
