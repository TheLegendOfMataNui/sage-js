...
/**
 * InstructionBCLGetObjectClassID constructor.
 */
@typed.decorate('InstructionBCLGetObjectClassID')
export class InstructionBCLGetObjectClassID extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetObjectClassID';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xBF);
