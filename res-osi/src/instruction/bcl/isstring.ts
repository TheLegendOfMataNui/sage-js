...
/**
 * InstructionBCLIsString constructor.
 */
@typed.decorate('InstructionBCLIsString')
export class InstructionBCLIsString extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'IsString';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xBA);
