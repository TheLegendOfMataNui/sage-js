...
/**
 * InstructionBCLGetAlphaValue constructor.
 */
@typed.decorate('InstructionBCLGetAlphaValue')
export class InstructionBCLGetAlphaValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetAlphaValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xA7);
