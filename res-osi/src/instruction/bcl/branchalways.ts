...
/**
 * InstructionBCLBranchAlways constructor.
 */
@typed.decorate('InstructionBCLBranchAlways')
export class InstructionBCLBranchAlways extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'BranchAlways';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x54);
