...
/**
 * InstructionBCLOr constructor.
 */
@typed.decorate('InstructionBCLOr')
export class InstructionBCLOr extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Or';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x6B);
