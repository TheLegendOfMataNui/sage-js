...
/**
 * InstructionBCLNop constructor.
 */
@typed.decorate('InstructionBCLNop')
export class InstructionBCLNop extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Nop';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x00);
