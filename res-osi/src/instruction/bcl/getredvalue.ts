...
/**
 * InstructionBCLGetRedValue constructor.
 */
@typed.decorate('InstructionBCLGetRedValue')
export class InstructionBCLGetRedValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetRedValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xA4);
