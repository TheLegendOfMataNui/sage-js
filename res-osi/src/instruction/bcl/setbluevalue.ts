...
/**
 * InstructionBCLSetBlueValue constructor.
 */
@typed.decorate('InstructionBCLSetBlueValue')
export class InstructionBCLSetBlueValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'SetBlueValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xA2);
