...
/**
 * InstructionBCLAdd constructor.
 */
@typed.decorate('InstructionBCLAdd')
export class InstructionBCLAdd extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Add';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x70);
