...
/**
 * InstructionBCLDup constructor.
 */
@typed.decorate('InstructionBCLDup')
export class InstructionBCLDup extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Dup';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x35);
