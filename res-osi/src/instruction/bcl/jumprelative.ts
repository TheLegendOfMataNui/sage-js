...
/**
 * InstructionBCLJumpRelative constructor.
 */
@typed.decorate('InstructionBCLJumpRelative')
export class InstructionBCLJumpRelative extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'JumpRelative';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x50);
