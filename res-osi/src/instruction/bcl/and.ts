...
/**
 * InstructionBCLAnd constructor.
 */
@typed.decorate('InstructionBCLAnd')
export class InstructionBCLAnd extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'And';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x6A);
