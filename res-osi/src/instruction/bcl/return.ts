...
/**
 * InstructionBCLReturn constructor.
 */
@typed.decorate('InstructionBCLReturn')
export class InstructionBCLReturn extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Return';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x52);
