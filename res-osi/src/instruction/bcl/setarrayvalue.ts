...
/**
 * InstructionBCLSetArrayValue constructor.
 */
@typed.decorate('InstructionBCLSetArrayValue')
export class InstructionBCLSetArrayValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'SetArrayValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x93);
