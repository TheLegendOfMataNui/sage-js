...
/**
 * InstructionBCLLessThan constructor.
 */
@typed.decorate('InstructionBCLLessThan')
export class InstructionBCLLessThan extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'LessThan';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x61);
