...
/**
 * InstructionBCLLineNumberAlt1 constructor.
 */
@typed.decorate('InstructionBCLLineNumberAlt1')
export class InstructionBCLLineNumberAlt1 extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'LineNumberAlt1';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x05);
