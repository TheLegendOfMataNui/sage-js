...
/**
 * InstructionBCLPower constructor.
 */
@typed.decorate('InstructionBCLPower')
export class InstructionBCLPower extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x74);
