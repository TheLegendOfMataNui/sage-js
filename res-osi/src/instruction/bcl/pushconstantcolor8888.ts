...
/**
 * InstructionBCLPushConstantColor8888 constructor.
 */
@typed.decorate('InstructionBCLPushConstantColor8888')
export class InstructionBCLPushConstantColor8888 extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'PushConstantColor8888';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x48);
	 ...
	 * Argument 0.
	 */
	public static readonly ARG0 = PrimitiveInt32U;
