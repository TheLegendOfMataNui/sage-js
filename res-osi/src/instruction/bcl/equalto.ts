...
/**
 * InstructionBCLEqualTo constructor.
 */
@typed.decorate('InstructionBCLEqualTo')
export class InstructionBCLEqualTo extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'EqualTo';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x60);
