...
/**
 * InstructionBCLShiftRight constructor.
 */
@typed.decorate('InstructionBCLShiftRight')
export class InstructionBCLShiftRight extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'ShiftRight';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x78);
