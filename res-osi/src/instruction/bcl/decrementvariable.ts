...
/**
 * InstructionBCLDecrementVariable constructor.
 */
@typed.decorate('InstructionBCLDecrementVariable')
export class InstructionBCLDecrementVariable extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'DecrementVariable';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x25);
