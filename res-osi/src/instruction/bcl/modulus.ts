...
/**
 * InstructionBCLModulus constructor.
 */
@typed.decorate('InstructionBCLModulus')
export class InstructionBCLModulus extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Modulus';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x75);
