...
/**
 * InstructionBCLSetVariableValue constructor.
 */
@typed.decorate('InstructionBCLSetVariableValue')
export class InstructionBCLSetVariableValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'SetVariableValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x22);
