...
/**
 * InstructionBCLPushNothing constructor.
 */
@typed.decorate('InstructionBCLPushNothing')
export class InstructionBCLPushNothing extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'PushNothing';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x47);
