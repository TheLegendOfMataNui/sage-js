...
/**
 * InstructionBCLGreaterOrEqual constructor.
 */
@typed.decorate('InstructionBCLGreaterOrEqual')
export class InstructionBCLGreaterOrEqual extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GreaterOrEqual';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x64);
