...
/**
 * InstructionBCLSetAlphaValue constructor.
 */
@typed.decorate('InstructionBCLSetAlphaValue')
export class InstructionBCLSetAlphaValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'SetAlphaValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xA3);
