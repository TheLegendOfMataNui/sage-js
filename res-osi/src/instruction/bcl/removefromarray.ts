...
/**
 * InstructionBCLRemoveFromArray constructor.
 */
@typed.decorate('InstructionBCLRemoveFromArray')
export class InstructionBCLRemoveFromArray
extends InstructionBCL {
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'RemoveFromArray';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x95);
