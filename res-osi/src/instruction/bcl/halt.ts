...
/**
 * InstructionBCLHalt constructor.
 */
@typed.decorate('InstructionBCLHalt')
export class InstructionBCLHalt extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Halt';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xFF);
