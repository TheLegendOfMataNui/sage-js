...
/**
 * InstructionBCLGetArrayValue constructor.
 */
@typed.decorate('InstructionBCLGetArrayValue')
export class InstructionBCLGetArrayValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetArrayValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x91);
