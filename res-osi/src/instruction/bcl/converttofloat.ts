...
/**
 * InstructionBCLConvertToFloat constructor.
 */
@typed.decorate('InstructionBCLConvertToFloat')
export class InstructionBCLConvertToFloat extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'ConvertToFloat';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xB1);
