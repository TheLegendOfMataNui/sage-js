...
/**
 * InstructionBCLJumpAbsolute constructor.
 */
@typed.decorate('InstructionBCLJumpAbsolute')
export class InstructionBCLJumpAbsolute extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'JumpAbsolute';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x51);
