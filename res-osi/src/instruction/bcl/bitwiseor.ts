...
/**
 * InstructionBCLBitwiseOr constructor.
 */
@typed.decorate('InstructionBCLBitwiseOr')
export class InstructionBCLBitwiseOr extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'BitwiseOr';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x6E);
