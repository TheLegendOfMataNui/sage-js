...
/**
 * InstructionBCLPushConstant0 constructor.
 */
@typed.decorate('InstructionBCLPushConstant0')
export class InstructionBCLPushConstant0 extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'PushConstant0';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x45);
