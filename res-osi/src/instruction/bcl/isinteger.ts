...
/**
 * InstructionBCLIsInteger constructor.
 */
@typed.decorate('InstructionBCLIsInteger')
export class InstructionBCLIsInteger extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'IsInteger';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xB8);
