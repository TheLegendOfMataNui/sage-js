...
/**
 * InstructionBCLDebugOn constructor.
 */
@typed.decorate('InstructionBCLDebugOn')
export class InstructionBCLDebugOn extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'DebugOn';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x02);
