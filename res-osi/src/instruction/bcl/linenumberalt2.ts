...
/**
 * InstructionBCLLineNumberAlt2 constructor.
 */
@typed.decorate('InstructionBCLLineNumberAlt2')
export class InstructionBCLLineNumberAlt2 extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'LineNumberAlt2';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x06);
