...
/**
 * InstructionBCLBitwiseAnd constructor.
 */
@typed.decorate('InstructionBCLBitwiseAnd')
export class InstructionBCLBitwiseAnd extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'BitwiseAnd';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x6D);
