...
/**
 * InstructionBCLCreateObject constructor.
 */
@typed.decorate('InstructionBCLCreateObject')
export class InstructionBCLCreateObject extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'CreateObject';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x13);
