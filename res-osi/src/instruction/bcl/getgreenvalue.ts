...
/**
 * InstructionBCLGetGreenValue constructor.
 */
@typed.decorate('InstructionBCLGetGreenValue')
export class InstructionBCLGetGreenValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetGreenValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xA5);
