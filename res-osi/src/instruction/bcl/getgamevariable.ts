...
/**
 * InstructionBCLGetGameVariable constructor.
 */
@typed.decorate('InstructionBCLGetGameVariable')
export class InstructionBCLGetGameVariable extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetGameVariable';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x80);
