...
/**
 * InstructionBCLSubtract constructor.
 */
@typed.decorate('InstructionBCLSubtract')
export class InstructionBCLSubtract extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Subtract';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x71);
