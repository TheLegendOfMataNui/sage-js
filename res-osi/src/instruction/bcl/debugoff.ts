...
/**
 * InstructionBCLDebugOff constructor.
 */
@typed.decorate('InstructionBCLDebugOff')
export class InstructionBCLDebugOff extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'DebugOff';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x03);
