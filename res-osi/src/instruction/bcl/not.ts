...
/**
 * InstructionBCLNot constructor.
 */
@typed.decorate('InstructionBCLNot')
export class InstructionBCLNot extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Not';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x6C);
