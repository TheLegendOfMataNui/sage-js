...
/**
 * InstructionBCLCallGameFunction constructor.
 */
@typed.decorate('InstructionBCLCallGameFunction')
export class InstructionBCLCallGameFunction extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'CallGameFunction';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x82);
