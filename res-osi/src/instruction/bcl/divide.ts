...
/**
 * InstructionBCLDivide constructor.
 */
@typed.decorate('InstructionBCLDivide')
export class InstructionBCLDivide extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Divide';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x73);
