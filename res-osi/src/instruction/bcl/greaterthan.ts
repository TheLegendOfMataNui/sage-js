...
/**
 * InstructionBCLGreaterThan constructor.
 */
@typed.decorate('InstructionBCLGreaterThan')
export class InstructionBCLGreaterThan extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GreaterThan';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x62);
