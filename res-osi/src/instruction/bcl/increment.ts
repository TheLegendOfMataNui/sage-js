...
/**
 * InstructionBCLIncrement constructor.
 */
@typed.decorate('InstructionBCLIncrement')
export class InstructionBCLIncrement extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'Increment';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x7A);
