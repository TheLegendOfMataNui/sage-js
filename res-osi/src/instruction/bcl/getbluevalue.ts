...
/**
 * InstructionBCLGetBlueValue constructor.
 */
@typed.decorate('InstructionBCLGetBlueValue')
export class InstructionBCLGetBlueValue extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'GetBlueValue';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0xA6);
