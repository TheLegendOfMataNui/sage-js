...
/**
 * InstructionBCLPushConstanti16 constructor.
 */
@typed.decorate('InstructionBCLPushConstanti16')
export class InstructionBCLPushConstanti16 extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'PushConstanti16';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x42);
