...
/**
 * InstructionBCLSetGameVariable constructor.
 */
@typed.decorate('InstructionBCLSetGameVariable')
export class InstructionBCLSetGameVariable extends
	InstructionBCL {
	/**
	 * Instruction size.
	 */
	 ...
	 * Opcode name.
	 */
	public static readonly NAME = 'SetGameVariable';

	/**
	 * The opcode.
	 */
	public static readonly OPCODE = new PrimitiveInt8U(0x81);
